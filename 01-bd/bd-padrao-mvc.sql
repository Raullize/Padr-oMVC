CREATE DATABASE IF NOT EXISTS `bd-padrao-mvc`
...
--
-- Host: 127.0.0.1    Database: bd-padrao-mvc
-- ------------------------------------------------------
...
(
        6,
        'Ensino Médio Integrado',
        'Ciências Humanas, Comportamentais, Linguagens e Artes'
    ),
(7, 'Ensino Médio Integrado', 'Engenharias'),
(8, 'Ensino Médio Integrado', 'Informática'),
(9, 'Ensino Médio Integrado', 'Meio Ambiente'),
(
        10,
...
(
        4,
        'Com são realizadas as avaliações',
...
(
        ...
        'Fábio Santos Fábio',
        'fabio3268@gmail.com',
        '$2y$10$ipz.8RVkp8k6UMcgGdoBa.JKvG6sM6lh0j/ZqLwitoWtLuwhjBnz.',
        NULL,
        '2022-09-02 11:11:38',
        NULL
    );
